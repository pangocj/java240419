...
//직렬 직렬화(Object Serialization) : 객체를 원시데이타로 변환하여 입력스트림 또는 출력스트림으로
//전달하기 위한 기능을 제공 
// => 객체를 byte 배열로 변환하거나 byte 배열을 객체로 변환하여 전달되도록 설정

//클래스를 객체 직렬화 클래스로 선언하는 방법
//1.Serializable 인터페이스를 상속받아 클래스를 작성
