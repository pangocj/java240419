...
public class LamdaApp {
	public static void main(String[] args) {
		//Consumer<T> 함수형 인터페이스 : 제네릭으로 전달된 Java 자료형의 객체를 매개변수로 전달받아
		//처리하고 아무것도 반환하지 않는 accept() 추상메소드가 작성된 함수형 인터페이스
		int number=100;
		
		/*
		//Consumer 함수형 인터페이스를 상속받은 익명클래스를 사용해 객체를 생성하여 참조변수에 저장
