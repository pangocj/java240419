...
<body>
	...
	- HTML 태그와 구분하기 위해 [jsp] 네임스페이스(NameSpace) 사용하여 태그 사용 : JSP 태그</p>
	<hr>
	<p>include 태그 : 요청 JSP 문서의 스레드를 다른 JSP 문서로 이동하여 실행된 결과(웹문서)를
	제공받아 태그를 사용한 위치에 포함하는 태그</p>
	<p>forward 태그 : 요청 JSP 문서의 스레드를 다른 JSP 문서로 이동하여 실행된 결과(웹문서)를
	클라이언트에게 전달하여 응답하는 태그</p>
	<p>param 태그 : 요청 JSP 문서에서 스레드가 이동된 JSP 문서로 값을 전달하기 위한 태그
