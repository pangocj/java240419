...
/*
MYHEOWN 테이블 : 회원정보를 저장하기 위한 테이블  
create table myhewon(hewon_id varchar2(50) primary key, hewon_name varchar2(50)
    , hewon_phone varchar2(20), hewon_email varchar2(100), hewon_scope number(1));
...
public class MyHewon {
	...
	public MyHewon(String id, String name, String phone, String email, int scope) {
		super();
		this.id = id;
		this.name = name;
		this.phone = phone;
