...
<%-- => [글저장] 태그를 클릭한 경우 [/review/review_write_action.jsp] 문서를 요청하여 페이지 이동 - 입력값 전달 --%>

<%-- 비로그인 사용자가 JSP 문서를 요청한 경우 에러페이지로 이동되도록 응답 처리 --%>
<%@include file="/security/login_check.jspf" %>    

<%
	//새글 : [/review/review_list.jsp] 문서에서 JSP 문서를 요청한 경우 - 전달값 : X
	//답글 : [/review/review_detail.jsp] 문서에서 JSP 문서를 요청한 경우 - 전달값 : O
	
	//전달값을 반환받아 저장 - 전달값이 없는 경우에는 변수에 기본값 저장
