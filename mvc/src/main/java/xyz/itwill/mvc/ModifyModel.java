...
//클라이언트가 [/modify.do]로 페이지를 요청한 경우 객체로 생성될 모델 역활의 클래스
// => 회원정보를 전달받아 USERINFO 테이블에 저장된 행을 변경하고 [/view.do] 주소로 리다이렉트
...
public class ModifyModel implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//UserinfoService 클래스의 modifyUserinfo() 메소드를 호출하여 회원등록 처리
