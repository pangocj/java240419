...
public class UserinfoService {
	...
	//회원정보를 전달받아 USERINFO 테이블에 행으로 삽입하는 메소드
	...
	//아이디를 전달받아 USERINFO 테이블에 저장된 행을 삭제하는 메소드
	...
	//아이디를 전달받아 USERINFO 테이블에 저장된 행을 검색하여 회원정보로 반환하는 메소드
	// => 매개변수로 전달받은 아이디의 회원정보가 USERINFO 테이블에 없는 경우 인위적 예외 발생
