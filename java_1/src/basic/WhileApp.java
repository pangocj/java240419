...
//while : 조건식에 의해 명령을 반복 실행하기 위한 문장을 작성하는 키워드

//형식) while(조건식) { 명령; 명령; ... }
// => 조건식의 결과가 참인 경우 블럭 내부의 명령을 반복 실행하고 조건식이 결과가 거짓인 경우 반복문 종료
// => 반복의 횟수가 명확하지 않은 경우 사용하는 반복문
// => 조건식을 생략할 수 없으면 블럭 내부의 명령을 0번 이상 실행
...
public class WhileApp {
	public static void main(String[] args) {
		...
		System.out.println("[결과]"+cnt+"번 접으면 "+gae+"개의 사각형 모양이 만들어집니다.");
		System.out.println("==============================================================");
		//1~X 범위의 정수들의 합계가 300 이상이 만들어지려면 X가 얼마인지 계산하여 출력하는 프로그램 작성
		int x=0, sum=0;//x : 1씩 증가되는 정수값 저장, sum : 합계 저장
